 ...
 */
router.post('/:alias/batch/start', async (ctx: any) => {
  try {
 ...
 */
router.post('/batch/:sessionId/process', async (ctx: any) => {
  try {
    const { sessionId } = ctx.params;
    const documents: Product[] = ctx.request.body;
 ...
 */
router.post('/batch/:sessionId/complete', async (ctx: any) => {
  try {
    const { sessionId } = ctx.params;
 ...
 *         description: Session not found
 */
router.get('/batch/:sessionId/status', async (ctx: any) => {
  try {
    const { sessionId } = ctx.params;
 ...
 */
router.post('/batch/:sessionId/cancel', async (ctx: any) => {
  try {
    const { sessionId } = ctx.params;
 ...
 *                 $ref: '#/components/schemas/BatchSession'
 */
router.get('/batch/active', async (ctx: any) => {
  try {
 ...
 */
router.get('/:alias/status', async (ctx: any) => {
  try {
    const { alias } = ctx.params;
 ...
 */
router.post('/:alias/promote', async (ctx: any) => {
  try {
    const { alias } = ctx.params;
