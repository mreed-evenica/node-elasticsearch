...
//  *   post:
//  *     summary: Process a batch of documents (deprecated - use product-specific endpoint)
//  *     description: Add a batch of documents to an active batch session. Please use /api/v1/products/batch/{sessionId}/process for product batches
//  *     tags: [Blue/Green Batch Processing]
//  *     deprecated: true
//  *     parameters:
//  *       - in: path
...
//  *               type: object
//  *             maxItems: 5000
//  *             description: Array of documents (max 5000 per batch)
//  *     responses:
//  *       410:
//  *         description: This endpoint is deprecated. Use product-specific batch processing.
//  */
// router.post('/batch/:sessionId/process', async (ctx: ExtendedKoaContext) => {
//   ctx.status = 410;
//   ctx.body = {
//     error: 'This endpoint is deprecated. Please use /api/v1/products/batch/{sessionId}/process for product batch processing.',
//     alternativeEndpoint: '/api/v1/products/batch/{sessionId}/process',
//     migration: {
//       message: 'This endpoint has been moved to a product-specific route under the v1 API.',
//       newEndpoint: '/api/v1/products/batch/{sessionId}/process',
//       changes: [
//         'Moved to versioned API under /api/v1',
//         'Product-specific batch processing',
